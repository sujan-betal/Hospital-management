          ...
          <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-sm bg-white rounded-3xl border border-[#E8ECEB] shadow-2xl p-6 z-50 animate-fade-in">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-[#0B2B26]">Sign Out</h3>
                  <p className="text-xs text-[#8AA098] mt-0.5">Are you sure you want to sign out?</p>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 h-11 rounded-xl bg-[#C4392A] text-white text-xs font-bold hover:bg-[#A32E21] shadow-md shadow-red-600/10 transition-all flex items-center justify-center gap-2"
              >
